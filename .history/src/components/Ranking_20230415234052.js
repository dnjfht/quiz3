...
const RankingData = styled.div`
  ...
  background-color: ${(props) =>
    props.highlight === true ? "#a6c9e1" : "#fff"};

  border-radius: 6px;
  border: ${(props) =>
    props.highlight === true ? "none" : "2px solid #a6c9e1 "};
...
const Grade = styled.p`
  ...
  box-sizing: border-box;
  border-right: ${(props) =>
    props.highlight === true ? "1px solid rgb(0, 212, 255)" : "1px solid #fff"};

  font-size: 2rem;
  color: ${(props) => (props.highlight === true ? "#a6c9e1" : "white")};
...
const ScoreNumber = styled.p`
  ...
  box-sizing: border-box;
  border-right: ${(props) =>
    props.highlight === true ? "1px solid #a6c9e1" : "1px solid #fff"};
...
const RankName = styled.p`
  ...
  padding-bottom: 10px;
  border-bottom: ${(props) =>
    props.highlight ? "1px solid rgb(0, 212, 255)" : "1px solid #fff"};

  font-size: 1rem;
  color: ${(props) => (props.highlight ? "rgb(0, 212, 255)" : "white")};
  font-weight: 600;
`;
